...
const FloatingAdvisorCTA = () => (
  <a
    ...
    className="fixed z-[9990] bottom-6 right-6 max-[480px]:bottom-4 max-[480px]:right-4
      ...
      w-16 h-16 max-[480px]:w-14 max-[480px]:h-14
      bg-background border border-foreground/80
      shadow-[0_6px_20px_rgba(0,0,0,0.2)]
      hover:scale-[1.06] hover:shadow-[0_8px_28px_rgba(0,0,0,0.28)]
      transition-all duration-300"
  >
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
      className="w-8 h-8 max-[480px]:w-7 max-[480px]:h-7 fill-foreground"
    >
