...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `
      <div class="mb-8">
        <img
          src="/argentina-golden-visa-argentinaresidence.jpg"
      ...
      <p class="mb-6">The global investment migration market has been anticipating the Argentinian Citizenship program for years. As traditional European programs close under regulatory pressure and Caribbean nations harmonize their pricing upwards, the industry is actively seeking new participants. Argentina has been teasing its citizenship by investment program for all of 2026 and has captured significant attention from globally minded investors. However, recent developments suggest that while the legal framework exists, the operational reality still needs some tweaking.</p>

      <p class="mb-6">In this analysis, we discuss what we have been seeing from prospective Argentinian investors, the current state of the program, the implications of its April tender cancellation, and its potential positioning within the broader $20 billion global investment migration market — with a focused view on the Argentina CBI timeline and the most likely launch date.</p>

      <h2 class="text-3xl font-serif mb-6 mt-12">The Legal Shell and the Missing Keys</h2>

      <p class="mb-6">The foundation for Argentina's CBI program was laid out in May 2025 with <strong>Decree 366/2025</strong>, which amended the country's citizenship law. This pivotal legislation allowed foreign nationals to naturalize through a "relevant investment", bypassing the standard two-year residency requirement. Additional legislation established the <strong>Agencia de Programas de Ciudadanía por Inversión (APCI)</strong> under the Ministry of Economy to administer the program, and outlined a multi-agency vetting process involving Immigration, security, the Financial Intelligence Unit, and the intelligence secretariat (SIDE). A February 2026 law further clarified that citizenship obtained through investment would not automatically trigger Argentine tax residency — a clarification that removed a significant deterrent for high-net-worth individuals.</p>

      <p class="mb-6">Despite these legislative revisions, the program still lacks the essential operational components required to function. As of late April 2026, Argentina has not defined investment thresholds, eligible sectors, qualifying project categories, application procedures or due diligence protocols.</p>

      <p class="mb-6">The government's initial strategy to bridge this operational gap was to outsource the program's design and management to a third-party master agent via a four-year public contract. This approach collapsed on April 14, 2026, when Economy Minister Luis Caputo signed <strong>Resolution 522/2026</strong>, voiding the international procurement tender.</p>

      <h2 class="text-3xl font-serif mb-6 mt-12">Analysis of the Tender Collapse</h2>

      <p class="mb-6">The cancellation of the master agent tender highlights the complexities of launching a sovereign CBI program. The evaluation commission had initially recommended awarding the contract to a four-firm consortium operating under the Chilean entity <em>Asesorías Legal Advisor Limitada</em>. This recommendation was derailed following formal challenges from two competing bidders: <strong>Henley &amp; Partners</strong>, which placed second, and <strong>Latitude Consultancy</strong>, which was disqualified early on for insufficient financial solvency.</p>

      <p class="mb-6">A technical review by the Ministry's legal and administrative secretariat revealed significant issues. The review concluded that the remaining bids showed "relevant divergences" and failed to ensure the necessary "degree of coherence, integrality, and strategic articulation."</p>

      <p class="mb-6">The economic disparity between the finalists was particularly striking. Both finalists received identical technical scores of 48 points, but their financial proposals were vastly different. The disparity in bids, economic models and divergent approaches led the Argentinian ministry to cancel the tender entirely and award no contract.</p>

      <h2 class="text-3xl font-serif mb-6 mt-12">The Pivot to In-House Development</h2>

      <p class="mb-6">Argentina appears to be pivoting toward building the program's infrastructure internally after the tender's collapse. On April 27, 2026, President Javier Milei signed <strong>Decree 285/2026</strong> and appointed <strong>Aixa Granara</strong> as the Executive Director of APCI. This arrangement is widely interpreted as a placeholder role that will convert to a salaried position once the program begins generating revenue from application fees.</p>

      <h2 class="text-3xl font-serif mb-6 mt-12">Market Positioning — The Potential of the Argentine Passport</h2>

      <p class="mb-6">If Argentina successfully operationalizes its CBI program, it will compete aggressively in the global market. The Argentine passport is highly desirable and offers visa-free or visa-on-arrival access to approximately <strong>168 to 170 countries</strong>, including the Schengen Area, the United Kingdom, Japan and South Korea. This level of global mobility places Argentina in the upper echelons of passport rankings and significantly outperforms many existing CBI options.</p>

      <p class="mb-6">The potential revenue generation for successful CBI programs is massive. Dominica processed over 30,000 applications in four years and CBI revenues account for up to 30% of GDP. Portugal's Golden Visa program has generated over $10 billion in direct investment and resulted in a total estimated economic impact of over $55 billion. We expect Argentina to capture a significant share of the high-net-worth investor market and most of the United States investor market.</p>

      <h2 class="text-3xl font-serif mb-6 mt-12">Watching and Waiting — The Q4 2026 Launch Window</h2>

      <p class="mb-6">The demand for alternative or additional citizenship remains at all-time highs, driven by geopolitical instability, rising taxes, and the desire for enhanced global mobility. Investors are increasingly building portfolios of residencies and citizenships to mitigate risks.</p>

      <p class="mb-6">Argentina's targeted entrance into the CBI market in <strong>Q4 2026</strong> represents a high-stakes endeavor. The legal framework is established and the potential benefits — both for the country in terms of foreign direct investment and for investors seeking a powerful passport — are substantial. However, the operational void left by the cancelled master agent tender may present a challenge to that launch window.</p>

      <p class="mb-6">The global investment migration industry is watching closely, and investors are keen to stay up to date on the program's timeline. The success of Argentina's CBI program will depend entirely on the government's ability to swiftly and transparently build the operational infrastructure required to process applications and ensure due diligence. For investors who want to be positioned before the launch, we publish ongoing coverage on our <a href="/research" class="text-primary hover:underline font-semibold">Research and Intelligence</a> page.</p>

      <h2 class="text-3xl font-serif mb-6 mt-12">References</h2>

      <ul class="mb-6 ml-6 list-disc space-y-2">
        <li>Passportivity. "Citizenship by Investment Programmes in 2026: Key Numbers, Risks, and Trends." <a href="https://passportivity.com/reports-and-ratings/investment-citizenship-analytics/" class="text-primary hover:underline" target="_blank" rel="noopener noreferrer">passportivity.com</a></li>
        <li>IMI Daily. "Argentina Names CBI Agency Director. The Program She'll Direct Doesn't Exist Yet."</li>
        <li>KPMG. "Argentina – Investing in Argentina: New Pathway to Citizenship." GMS Flash Alert 2025-144. <a href="https://kpmg.com/xx/en/our-insights/gms-flash-alert/flash-alert-2025-144.html" class="text-primary hover:underline" target="_blank" rel="noopener noreferrer">kpmg.com</a></li>
        <li>Wikipedia. "Visa requirements for Argentine citizens." <a href="https://en.wikipedia.org/wiki/Visa_requirements_for_Argentine_citizens" class="text-primary hover:underline" target="_blank" rel="noopener noreferrer">wikipedia.org</a></li>
      </ul>
    `
  },
  {
